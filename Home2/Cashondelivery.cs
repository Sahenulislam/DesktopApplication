...
namespace Home2
{
    public partial class Cashondelivery : Form
    {
        string Namex = null;
        string Idx = null;
        string Emailx = null;
        ...
        public Cashondelivery(string procategory, string pro_id, string Type, string Namex, string Idx, string Emailx)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string delivery = "Cash on Delivary";
            string ProCategory = null;
            ...
            connn.Open();     
            string query = "insert into product_buy(sell_id,user_name,pro_id,user_phone,address,delivery,pro_price,pro_name,pro_category,pro_quantity)values('null','" + username + "','" + proid + "','" + userphone + "','" + address + "','" + delivery + "','" + ProPrice + "','" + ProName + "','" + ProCategory + "','" + ProQuantity + "');";
